...
Webots is asking to playback the resulting file in the default browser (from the OS settings).
...
(cf. [section below](#remarks-on-the-used-technologies-and-their-limitations))
