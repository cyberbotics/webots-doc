...
To link these libraries with your project, their source files should be built directly in your project,
exactly as the `libCppController` is linked (cf. instructions above).
