...
Disabling the [ImageTexture](imagetexture.md) filtering (i.e. to set `ImageTexture.filtering = 0`) is recommended to get a sharp rendering (otherwise the anisotropic filtering may affect the result).
