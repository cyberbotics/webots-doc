...
[Physics](reference/physics.md#physics) nodes. A more complete example of this
PROTO named `SimpleChair` is provided in Webots distribution.
...
of the PROTO's [Solid](reference/solid.md#solid) base node. This allows to store
the position and orientation of the PROTO instances.
