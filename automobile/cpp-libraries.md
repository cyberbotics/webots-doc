...
| &nbsp;&nbsp; enum {SPEED, TORQUE };                                                                          |
| &nbsp;&nbsp; enum {WIPER\_DOWN, WIPER\_SLOW, WIPER\_NORMAL, WIPER\_FAST};                                    |
...
| &nbsp;&nbsp; void [setWiperMode](driver-library.md#wbu_driver_set_wipers_mode)(int mode);                    |
| &nbsp;&nbsp; int [getWiperMode](driver-library.md#wbu_driver_set_wipers_mode)();                             |
| };                                                                                                           |
