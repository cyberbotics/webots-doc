...
- `lookupTable`: similar to the one used by the [DistanceSensor](#distancesensor)
node.
...
the `boundingObject` of any other [Solid](#solid) object. The `lookupTable`
field of a "bumper" sensor is ignored. The [Physics](#physics) node of a
...
[DistanceSensor](#distancesensor) for more info). Note that the default
...
([WorldInfo](#worldinfo) node) decreases.
...
{[C++](#cpp_touch_sensor)}, {[Java](#java_touch_sensor)}, {[Python](#python_touch_sensor)}, {[Matlab](#matlab_touch_sensor)}
