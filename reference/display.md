...
These functions are used to attach/detach a camera to a display. If a camera is attached to a display, as soon as a new image is generated by the camera it is efficiently copied in the display. This is useful to simulate mirrors for example.
