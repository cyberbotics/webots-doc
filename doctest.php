<?php
  ...
  if (substr($request_uri, 0, 9) != "/doctest/") { # redirect aliases
    $request_uri = "/doctest/".substr($request_uri, 1)."/index"; // we remove the "/" prefix
  ...
  if (!isset($repository))
    $repository = 'omichel';
  $scripts="
    <link rel='stylesheet' type='text/css' href='https://www.cyberbotics.com/wwi/R2018a/webots-doc.css'/>
