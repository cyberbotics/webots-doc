...
each robot. The controller name is a platform and language independent field; for
...
controller's name. For example if the controller's name is "xyz\_controller", then
