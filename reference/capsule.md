...
A [Capsule](reference/capsule.md#capsule) node is like a
[Cylinder](reference/cylinder.md#cylinder) node except it has half-sphere caps
at its ends. The capsule's height, not counting the caps, is given by the
`height` field. The radius of the caps, and of the cylinder itself, is given by
the `radius` field. Capsules are aligned along the local y-axis.
