...
{[C++](#cpp_accelerometer)}, {[Java](#java_accelerometer)}, {[Python](#python_accelerometer)}, {[Matlab](#matlab_accelerometer)}
...
[WorldInfo](#worldinfo) node. To obtain the acceleration due to motion alone,
