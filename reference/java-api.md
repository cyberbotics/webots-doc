...
| &nbsp;&nbsp; public double[] [getBoneOrientation](skin.md#wb_skin_get_bone_orientation)(int index, boolean absolute);                |
| &nbsp;&nbsp; public double[] [getBonePosition](skin.md#wb_skin_get_bone_position)(int index, boolean absolute);                      |
