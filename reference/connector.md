...
[Physics](#physics) node in its parent node. But it is not necessary to add a
[Physics](#physics) node to the [Connector](#connector) itself.
...
{[C++](#cpp_connector)}, {[Java](#java_connector)}, {[Python](#python_connector)}, {[Matlab](#matlab_connector)}
