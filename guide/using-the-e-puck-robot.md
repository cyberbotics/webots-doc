...
If the e-puck robot is equipped with the ground sensors extension modeled in `E-puckDistanceSensor`, then the ground sensors measurements are represented by the three grayscale boxes.
