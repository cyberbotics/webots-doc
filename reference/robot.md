...
> **Note**: If the Robot node has one or more Solid (or derived) ancestor node, then the physical properties of the ancestor nodes will affect the Robot node physical behavior.
