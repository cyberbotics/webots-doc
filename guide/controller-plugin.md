...
The internal behavior of the `wb_robot_step` function call is the key point to
...
when required), and to call the `wbr_distance_sensor_set_value` function into the
