...
namespace webots {
  class Node {
    enum {
      NO_NODE,
      // VRML97 nodes
      APPEARANCE, BACKGROUND, BOX, COLOR, COMPOSED_CUBE_MAP_TEXTURE, COMPOSED_SHADER,
      CONE, COORDINATE, CYLINDER, DIRECTIONAL_LIGHT, ELEVATION_GRID, EXTRUSION,
      FOG, GROUP, IMAGE_TEXTURE, INDEXED_FACE_SET, INDEXED_LINE_SET, LIDAR, MATERIAL,
      MULTI_TEXTURE, MUSCLE, POINT_LIGHT, SHADER_PART, SHAPE, SPHERE, SPOT_LIGHT,
      SWITCH, TEXTURE_COORDINATE, TEXTURE_TRANSFORM, TRACK, TRACK_WHEEL, TRANSFORM,
      UNIFORM, VIEWPOINT, WORLD_INFO,
      // non-vrml geometry
      CAPSULE, PLANE,
      // robots
      ROBOT, SUPERVISOR, DIFFERENTIAL_WHEELS,
      // misc
      BALL_JOINT, BALL_JOINT_PARAMETERS, CHARGER, CONTACT_PROPERTIES, DAMPING, FLUID,
      FOCUS, HINGE_JOINT, HINGE_JOINT_PARAMETERS, HINGE_2_JOINT, HINGE_2_JOINT_PARAMETERS,
      IMMERSION_PROPERTIES, JOINT_PARAMETERS, LENS, LENS_FLARE, PHYSICS, RECOGNITION,
      SLIDER_JOINT, SOLID, SOLID_REFERENCE, SLOT, ZOOM,
      // devices
      ACCELEROMETER, BRAKE, CAMERA, COMPASS, CONNECTOR, DISPLAY, DISTANCE_SENSOR,
      EMITTER, GPS, GYRO, INERTIAL_UNIT, LED, LIGHT_SENSOR, LINEAR_MOTOR, MICROPHONE,
      PEN, POSITION_SENSOR, PROPELLER, RADAR, RADIO, RANGE_FINDER, ROTATIONAL_MOTOR,
      RECEIVER, SKIN, SPEAKER, TOUCH_SENSOR
    };
...
public class Node {
  public final static int NO_NODE,
    // VRML97 nodes
    APPEARANCE, BACKGROUND, BOX, COLOR, COMPOSED_CUBE_MAP_TEXTURE, COMPOSED_SHADER,
    CONE, COORDINATE, CYLINDER, DIRECTIONAL_LIGHT, ELEVATION_GRID, EXTRUSION,
    FOG, GROUP, IMAGE_TEXTURE, INDEXED_FACE_SET, INDEXED_LINE_SET, LIDAR, MATERIAL,
...
WB_NODE_NO_NODE
% VRML97 nodes
WB_NODE_APPEARANCE, WB_NODE_BACKGROUND, WB_NODE_BOX, WB_NODE_COLOR, WB_NODE_COMPOSED_CUBE_MAP_TEXTURE, WB_NODE_COMPOSED_SHADER, WB_NODE_CONE, WB_NODE_COORDINATE, WB_NODE_CYLINDER, WB_NODE_DIRECTIONAL_LIGHT, WB_NODE_ELEVATION_GRID, WB_NODE_EXTRUSION, WB_NODE_FOG, WB_NODE_GROUP, WB_NODE_IMAGE_TEXTURE, WB_NODE_INDEXED_FACE_SET, WB_NODE_INDEXED_LINE_SET, WB_NODE_LIDAR, WB_NODE_MATERIAL, WB_NODE_MULTI_TEXTURE, WB_NODE_MUSCLE, WB_NODE_POINT_LIGHT, WB_NODE_SHADER_PART, WB_NODE_SHAPE, WB_NODE_SPHERE, WB_NODE_SPOT_LIGHT, WB_NODE_SWITCH , WB_NODE_TEXTURE_COORDINATE, WB_NODE_TEXTURE_TRANSFORM, WB_NODE_TRACK, WB_NODE_TRACK_WHEEL, WB_NODE_TRANSFORM, WB_NODE_UNIFORM, WB_NODE_VIEWPOINT, WB_NODE_WORLD_INFO
% non-vrml geometry
WB_NODE_CAPSULE, WB_NODE_PLANE
% robots
WB_NODE_ROBOT, WB_NODE_SUPERVISOR, WB_NODE_DIFFERENTIAL_WHEELS
% misc
WB_NODE_BALL_JOINT, WB_NODE_BALL_JOINT_PARAMETERS, WB_NODE_CHARGER, WB_NODE_CONTACT_PROPERTIES, WB_NODE_DAMPING, WB_NODE_FLUID, WB_NODE_FOCUS, WB_NODE_HINGE_JOINT, WB_NODE_HINGE_JOINT_PARAMETERS, WB_NODE_HINGE_2_JOINT, WB_NODE_HINGE_2_JOINT_PARAMETERS, WB_NODE_IMMERSION_PROPERTIES, WB_NODE_JOINT_PARAMETERS, WB_NODE_LENS, WB_NODE_LENS_FLARE, WB_NODE_PHYSICS, WB_NODE_RECOGNITION, WB_NODE_SLIDER_JOINT, WB_NODE_SOLID, WB_NODE_SOLID_REFERENCE, WB_NODE_SLOT, WB_NODE_ZOOM
% devices
WB_NODE_ACCELEROMETER, WB_NODE_BRAKE, WB_NODE_CAMERA, WB_NODE_COMPASS, WB_NODE_CONNECTOR, WB_NODE_DISPLAY, WB_NODE_DISTANCE_SENSOR, WB_NODE_EMITTER, WB_NODE_GPS, WB_NODE_GYRO, WB_NODE_INERTIAL_UNIT, WB_NODE_LED, WB_NODE_LIGHT_SENSOR, WB_NODE_LINEAR_MOTOR, WB_NODE_MICROPHONE, WB_NODE_PEN, WB_NODE_POSITION_SENSOR, WB_NODE_PROPELLER, WB_NODE_RADAR, WB_NODE_RADIO, WB_NODE_RANGE_FINDER, WB_NODE_ROTATIONAL_MOTOR, WB_NODE_RECEIVER, WB_NODE_SKIN, WB_NODE_SPEAKER, WB_NODE_TOUCH_SENSOR
