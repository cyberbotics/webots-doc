...
namespace webots {
  class Node {
    typedef enum {
      ...
      DIRECTIONAL_LIGHT, ELEVATION_GRID, FOG, GROUP, IMAGE_TEXTURE,
      ...
      RADAR, RANGE_FINDER, ROTATIONAL_MOTOR, RECEIVER, SPEAKER, TOUCH_SENSOR,
      // misc
      ...
      LENS_FLARE, PHYSICS, RECOGNITION, SLIDER_JOINT, SLOT, SOLID,
...
WB_NODE_SLOT, WB_NODE_SOLID, WB_NODE_SOLID_REFERENCE, WB_NODE_TRACK,
