...
| &nbsp;&nbsp; public double [getMaxRange](camera.md#wb_camera_get_range_image)();                                     |
| &nbsp;&nbsp; public int [getType](camera.md#wb_camera_get_type)();                                                   |
...
| &nbsp;&nbsp; public float[] [getRangeImage](camera.md#wb_camera_get_range_image)();                                  |
| &nbsp;&nbsp; public static float [rangeImageGetDepth](camera.md#wb_camera_get_range_image)(float[] image,            |
...
| &nbsp;&nbsp; public int [movieGetStatus](supervisor.md#wb_supervisor_movie_start_recording)();                                                                |
