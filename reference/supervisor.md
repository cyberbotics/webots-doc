...
number of item and the total number of item minus one, otherwise the value of the field remains unchanged (and a warning message is displayed). Using a negative index implies starting the count from the last element of the field to the first.
