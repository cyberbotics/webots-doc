...
It is necessary to set the `filtering` field of this [ImageTexture](imagetexture.md) node to 0 in order to prevent issues when distancing oneself from the display.
