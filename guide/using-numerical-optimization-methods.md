...
controller that called the `wb_supervisor_world_reload` function, this is usually the
...
the `wb_supervisor_world_reload` function and reloaded when the `Supervisor`
