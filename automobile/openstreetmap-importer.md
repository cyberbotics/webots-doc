...
| --removal-radius       | Specifies the radius (in meters) around each road waypoint outside which any object are removed.                                     | By default this feature is disabled (radius = 0.0).                       |
%end
